...
using Glimpse.Orchard.PerformanceMonitors.Extensions;
...
namespace Glimpse.Orchard.Glimpse.PerformanceMonitors
{
    [OrchardSuppressDependency("Glimpse.Orchard.PerfMon.Services.DefaultPerformanceMonitor")]
    public class GlimpsePerformanceMonitor : NullPerformanceMonitor, IPerformanceMonitor
    {
