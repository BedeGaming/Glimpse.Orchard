...
{
    /* This file allows for Glimpse to be run in async mode.
     * 
     * Unless you have <add key="Glimpse:DisableAsyncSupport" value="true"/> in your app settings, then you will need to register this class in order for Orchard to be able to restart it's app domain.
     * 
     * Regstration can be done in your Hosts.config file eg:
     * 
     *  <configuration>        
     *    <configSections>
     ...
     *      <components>
     *        <component instance-scope="single-instance" type="Glimpse.Orchard.AlternateImplementations.AsyncGlimpseHostEnvironment, Glimpse.Orchard" service="Orchard.Environment.IHostEnvironment"></component>
     *      </components>
     *    </autofac>    
     *  </configuration>     
     */

    public class AsyncGlimpseHostEnvironment : HostEnvironment
    {
        ...
        public AsyncGlimpseHostEnvironment(IClock clock, IHttpContextAccessor httpContextAccessor)  
        {
            _clock = clock;
